...
st.write("\n--- Notes ---")
st.info("To run this Streamlit app, save the code as `app.py`, and ensure `xgb_tuned_model.pkl` and `label_encoders.pkl` are in the same directory. Then run `streamlit run app.py` in your terminal.")